...
//// Especificações do áudio: FS=16kHz; WAV 16 bit big-endian PCM.
...
const int tempo_ms = 500000; int t1,t2 =0; 
const int tempograv = TEMPO*1000; // o tempo de gravacao está definido em post_functions.hh
int twifi1,twifi2=0;
...
void setup(){
  Serial.begin(921600); 
  pinMode(12,OUTPUT);
  xTaskCreate(main_task, "Main", 33000, NULL, 0, NULL); 
